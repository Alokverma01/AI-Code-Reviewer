...
`;
const WELCOME_MESSAGE_TEMPLATE = (name, email) => ({
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h3>Hi ${name},</h3>
          <p>
            We're excited to have you onboard! Your account has been successfully created with the email:
          </p>
          <p><strong>${email}</strong></p>
          <p>
            You can now start reviewing code, analyzing repositories, and improving your development workflow with AI-powered insights.
          </p>
